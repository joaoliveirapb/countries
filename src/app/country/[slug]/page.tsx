...
import { LoaderSkeletonSecondary } from '@/components/LoaderSkeletonSecondary'
      ...
      {country ? (
        country.map((item) => (
          <div
            ...
            className="mt-16 flex justify-between gap-4 max-[1225px]:flex-col max-[1225px]:gap-8"
          >
            <div>
              <Image
                src={item.flags.svg}
